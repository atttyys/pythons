...
class Calculator:
    def __init__(self, master):
        ...
        Button(width=11, height=4, text='x', relief='flat', bg='white', command=lambda: self.show('*')).place(x=270, y=125)  # Change 'x' to '*' for multiplication
        Button(width=11, height=4, text='=', relief='flat', bg='white', command=lambda: self.solve()).place(x=270, y=275)
